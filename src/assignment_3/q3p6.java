...
public class q3p6 extends JFrame {
	...
	public q3p6() {
		...
		comboBox.addItem(new operq3p3("Jaffna", 0));
		comboBox.addItem(new operq3p3("Kilinochchi", 1));
		comboBox.addItem(new operq3p3("Vavuniya", 2));
		comboBox.addItem(new operq3p3("Colombo", 3));
		
		JComboBox<Object> comboBox_1 = new JComboBox<Object>();
		comboBox_1.setBounds(182, 101, 75, 20);
		contentPane.add(comboBox_1);
		comboBox_1.addItem(new operq3p3("Jaffna", 0));
		comboBox_1.addItem(new operq3p3("Kilinochchi", 1));
		comboBox_1.addItem(new operq3p3("Vavuniya", 2));
		comboBox_1.addItem(new operq3p3("Colombo", 3));
		...
		btnGetDistance.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				int value1 = ((operq3p3)item1).getValue();
				String key1 = ((operq3p3)item1).getKey();
				
				Object item2 = comboBox_1.getSelectedItem();
				int value2 = ((operq3p3)item2).getValue();
				String key2 = ((operq3p3)item2).getKey();
				
				lblNewLabel_1.setText(key1);
				label.setText(key2);
				
				label_1.setText(Integer.toString(q3p5.getDistance(value1, value2)));
